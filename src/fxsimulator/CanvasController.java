...
public class CanvasController implements Initializable {
    ...
    @FXML public void ResetHandle(ActionEvent event) {
        nNode = 0;
        ...
        addNode = true; addEdge = false; calculate = false; calculated = false;
        addNodeButton.setSelected(true);
        addEdgeButton.setSelected(false);
        addEdgeButton.setDisable(true);
        clearButton.setDisable(true);
    }
    @FXML public void ClearHandle(ActionEvent event) {
        selectedNode = null;
        calculated = false;
    ...
    @FXML public void AddEdgeHandle(ActionEvent event) {
        addNode = false;
        addEdge = true;
        calculate = false;
    ...
    @FXML public void AddNodeHandle(ActionEvent event) {
        addNode = true;
        addEdge = false;
        calculate = false;
        addNodeButton.setSelected(true);
